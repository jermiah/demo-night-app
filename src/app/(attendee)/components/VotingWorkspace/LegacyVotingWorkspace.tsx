...
/**
 * Legacy Voting Workspace
 * 
 * Handles traditional award-based voting (Best Overall, Best Technology, etc.)
 * This is separate from match voting to keep concerns decoupled.
 */
export function LegacyVotingWorkspace() {
    ...
    <div className="absolute bottom-0 max-h-[calc(100dvh-120px)] w-full max-w-xl">
      <div className="flex size-full flex-col items-center justify-center gap-4 p-4">
        <div>
          ...
          <p className="text-md max-w-[330px] pt-2 text-center font-medium leading-5 text-muted-foreground">
            {isPitchNight
...
function AwardVoteItem({
  ...
  return (
    <div className="flex flex-col font-medium">
      ...
      <p className="text-md pb-2 pl-[2px] text-lg font-semibold italic leading-6 text-muted-foreground">
        {award.description}
      </p>
      <AwardVoteSelect
        award={award}
